...
var staticMethods = Object.keys(ParseClass).reduce(function (out, k) {
  if (has(ParseClass, k)) out[k] = ParseClass[k];
  return out;
}, {});
...
module.exports = function factory() {
  ...
  Object.assign(Parse, staticMethods); // Copy prototype and ensure (new Parse()) instanceof ParseClass == true

  Parse.prototype = Object.create(ParseClass.prototype);
  Parse.prototype.constructor = Parse; // Create an empty options object

  Parse.options = {}; // Register default transforms
